...
def run_steps(initial_word: str) -> tuple | None:
    """Run the steps for sentiment analysis of the word in question"""

    words_dict: dict[str, set[str]] = {
        "English": set(nltk_words.words()),
        "Luganda": load_words_to_set(file_path="C:/Users/HP/Desktop/tiktok-analysis/words/processed/luganda_words.txt"),
        "Swahili": load_words_to_set(file_path="C:/Users/HP/Desktop/tiktok-analysis/words/processed/swahili_words.txt"),
    }
